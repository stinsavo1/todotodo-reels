...
@Component({
    selector: 'app-name-factory',
    templateUrl: './name-factory.component.html',
    styleUrls: ['./name-factory.component.scss'],
    standalone: false
})

export class NameFactoryComponent implements OnInit {
  public item$: Observable<any>;
  public nameFactoryTouched: boolean = false;
  public items: any;
  private uid: string;
